...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <main className="relative flex-grow hero-background">
        {/* <div
          className="w-full h-screen lg:h-auto"
          style={
            windowWidth < 770
              ? { objectFit: "cover", objectPosition: "47%" }
              : {}
          }
        >
        </div> */}
        <div className="absolute inset-0 flex bg-black bg-opacity-30 lg:bg-opacity-10 items-center w-screen justify-center pl-8">
          <div className="w-screen text-center justify-center lg:text-white lg:ml-64 lg:justify-end">
            <h1
              className={`text-primary font-extrabold text-4xl font-bold mb-6 ${montserrat.className}`}
            >
              Explora Tu{" "}
              <strong
                className={`block lg:ml-32 font-extrabold text-white lg:text-6xl ${great_vibes.className}`}
              >
                {" "}
                Bienestar Interior
              </strong>
            ...
            <div className="mt-6 lg:ml-32 flex justify-center">
              <Link
                href="/servicios"
                className="block rounded-full bg-transparent border border-primary px-4 py-3 text-lg w-56 lg:text-sm font-bold text-primary shadow hover:text-white hover:bg-primary focus:shadow-light  focus:outline-none focus:ring-none active:text-white active:border active:border-end active:bg-primary"
              >
                Comienza tu viaje
              </Link>
            </div>
            <div className="mt-6 lg:ml-32 flex justify-center">
              <Link
                href="/acerca-de-mi"
                className="block rounded-full bg-transparent border border-white px-4 py-3 text-lg w-56 lg:text-sm font-bold text-white shadow hover:text-white hover:bg-secondary focus:shadow-accent  focus:outline-none focus:ring-none active:text-white active:border active:border-accent active:bg-secondary"
              >
                Conóceme
              </Link>
            </div>
      ...
      <footer className="w-full lg:px-8 py-3 absolute bottom-0 md:z-50 flex items-center justify-center bg-transparent">
        {" "}
        <div className="sm:px-16 sm:pt-16 w-full text-white flex flex-col">
