...
export default function Footer() {
  return (
    <footer className="w-full min-h-screen flex items-center justify-center bg-gradient-to-t from-transparent to-white" style={{ zIndex: 1 }}>
      <div className="md:w-2/3 w-full px-2 text-white flex flex-col">
        <div className="w-full text-3xl sm:text-xl font-bold">
        ...
        <div className="flex mt-4 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-400">En nuestro rincón de bienestar, estamos aquí para ti en cada paso de tu camino. Si tienes alguna pregunta o necesitas apoyo, no dudes en contactarnos. Creemos en construir juntos un camino hacia el bienestar.</p>
