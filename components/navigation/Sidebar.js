...
export default function Sidebar(isSidebarOpen) {
    ...
    return (
        <div
            className={`fixed inset-y-0 z-10 flex w-80 ${isOpen ? 'transform translate-x-0' : 'transform -translate-x-full'
                }`}
        >
            <svg
            ...
            <div className="z-10 flex flex-col flex-1">
                ...
                <nav className="flex flex-col flex-1 w-64 p-4 mt-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            <FaInstagram className="text-xl text-black hover:text-yellow-400 transition duration-300" />
                        </Link>
                        <Link
                        ...
                        >
                            <FaYoutube className="text-xl text-black hover:text-yellow-400 hover:scale-125 active:text-yellow-200 transition duration-300" />
                        </Link>
                        <Link
                        ...
                        >
                            <FaTiktok className="text-xl text-black hover:text-yellow-400 transition duration-300" />
                        </Link>
                        <Link
                        ...
                        >
                            <FaFacebook className="text-xl text-black hover:text-yellow-400 transition duration-300" />
                        </Link>
                        <Link
                        ...
                        >
                            <FaWhatsapp className="text-xl text-black hover:text-yellow-400 transition duration-300" />
                        </Link>
                    </div>
                </nav>
